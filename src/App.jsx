            ...
            {currentPage === 'login' && (
                <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-md border border-gray-100 my-auto">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); if (username && password) setCurrentPage('dashboard'); }} className="space-y-4">
                        ...
                        <button type="submit" className="w-full bg-red-800 hover:bg-red-900 text-white font-medium py-2.5 rounded-lg transition">Sign In</button>
                    </form>
                </div>
            )}
                ...
                <div className="w-full max-w-4xl bg-white p-6 rounded-xl shadow-md border border-gray-100">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b text-gray-500 text-sm bg-gray-50"><th className="p-3">Order Number</th><th className="p-3">Status</th><th className="p-3">Updated</th></tr>
                            </thead>
                            <tbody>
            ...
            {currentPage === 'details' && selectedOrder && (
                <div className="w-full max-w-4xl bg-white p-6 rounded-xl shadow-md border border-gray-100">
                    ...
                    <div className="bg-red-50 p-4 rounded-xl border border-red-100 text-center">
                        <span className="text-xs font-bold text-gray-500 block uppercase tracking-wider">Current Progress Status</span>
                        <span className="text-2xl font-bold text-red-900 block mt-1">{selectedOrder.status}</span>
                    </div>
                </div>
            )}
        </div>
